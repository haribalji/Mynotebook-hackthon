...
def summarize_text(text):
    ...
    "You should say 'I am displaying the content in this language' before printing the content.",
    ...
    "Keep in mind that you're displaying content for school students.",
     "you need summarize the content in short int tamil and english",
     "no html elements should appear inside the content"
   ],
